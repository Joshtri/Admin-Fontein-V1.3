...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 08, 2022 at 07:27 PM
...
--
-- Table structure for table `keluarga_umkm`
--

CREATE TABLE `keluarga_umkm` (
  `id_keluarga` int(20) NOT NULL,
  `nama_kepala_kel` varchar(110) NOT NULL,
  `alamat_tempat_tinggal` varchar(60) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `penduduk_umkm`
--

CREATE TABLE `penduduk_umkm` (
...
--
-- Indexes for table `keluarga_umkm`
--
ALTER TABLE `keluarga_umkm`
...
--
-- Indexes for table `penduduk_umkm`
--
ALTER TABLE `penduduk_umkm`
...
--
ALTER TABLE `kbli`
  MODIFY `id_kbli` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=91;
...
--
-- AUTO_INCREMENT for table `keluarga_umkm`
--
ALTER TABLE `keluarga_umkm`
  MODIFY `id_keluarga` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
-- AUTO_INCREMENT for table `penduduk_umkm`
--
ALTER TABLE `penduduk_umkm`
  MODIFY `id_penduduk` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
